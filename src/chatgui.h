...
private:
    ...
    // ChatLogic *_chatLogic; // raw pointer implementation
    std::unique_ptr<ChatLogic> _chatLogic;  // Using Unique pointer to make _chatLogic an exclusive resource of this class
